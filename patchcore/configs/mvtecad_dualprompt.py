...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--epochs', default=50, type=int)# TODO: change epoch
    ...
    # subparsers.add_argument('--nb-classes', default=15, type=int, help='images input size')
    ...
    subparsers.add_argument('--lr', type=float, default=0.02, metavar='LR', help='learning rate (default: 0.03)')
    ...
    subparsers.add_argument('--num_tasks', default=15, type=int, help='number of sequential tasks') #TODO: can change
    ...
    subparsers.add_argument('--size', default=15, type=int,) #pool size
    subparsers.add_argument('--prototype_size', default=8, type=int,)
    ...
    subparsers.add_argument('--freeze', default=['blocks', 'patch_embed', 'cls_token', 'norm', 'pos_embed', 'similar_module', 'prompt_cls_pool'], nargs='*', type=list, help='freeze part in backbone model')
